...
export default function Doctors() {
    ...
    const TreatmentsData = cardsdata["treatments"];
    ...
    return(<>
        ...
        <div className='bg-[#fffbff] grid grid-cols-[repeat(auto-fit,minmax(160px,1fr))] lg:grid-cols-[repeat(auto-fit,minmax(250px,1fr))] w-full justify-items-center  pb-10'>
        {
            hospitalsData.map((eachData, idx)=> (
        ...
        <ScrollDiv heading={'Best Treatments'} cardsData = {TreatmentsData} Card={TreatmentCard} count={6}/>       
