...
function HospitalInfo() {
  ...
  return (
    <>
      <div className="lg:flex justify-between px-2 lg:px-5 py-3 bg-[#f7ffff]">
        ...
        <div className="overflow-hidden rounded-lg shadow-xl" style={{ fontFamily: `"Convergence", sans-serif` }}>
          <div className="flex flex-col-reverse lg:flex-row lg:justify-between overflow-hidden lg:bg-gradient-to-b from-cyan-800 via-[#15495c] to-[#0e323f]">
            <div className="text-white bg-gradient-to-b from-cyan-800 via-[#15495c] to-[#0f3542] lg:bg-none lg:p-5 py-2 my-2 px-1 rounded-lg">
            ...
            <img src={hospitalInfo?hospitalInfo.img: '/img/loading.gif'} alt="Hospital" className={`aspect-[16/9] rounded-lg lg:rounded-none lg:aspect-[16/12] w-full lg:w-56 object-cover`} />
          </div>

          <div className=" px-2 lg:px-10 bg-white lg:bg-none tracking-tighter">
        ...
        <div className="lg:w-72 flex-shrink-0 self-start lg:border-none mt-12 border-t border-dotted border-[#b6c0ce] lg:mt-0 lg:ml-5 shadow-xl overflow-hidden rounded-xl sticky top-12 bg-gradient-to-b from-white via-white to-blue-300">
          <UserInfo />
        </div>
      </div>
