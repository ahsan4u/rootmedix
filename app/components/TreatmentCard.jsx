...
const TreatmentCard = ({data})=>{
    ...
    <div onClick={loadingFn} className="filter saturate-[1.33] sm:w-[150px] w-[105px] lg:mt-5 mt-3 mb-3 rounded-xl aspect-[8/11] relative overflow-hidden shadow-[2px_2px_5px_gray]">
        ...
        <img src="/img/treatmentCard.png" alt="" className="w-full absolute bottom-0 z-10 brightness-[0.9] contrast-[1.2]"/>
        <p className="w-full sm:text-[15px] text-[11px] text-center font-bold mb-1 sm:py-1 py-[1px] z-10 absolute bottom-0 text-cyan-50 transition-colors duration-[0.5s]">{data.name}</p>
    </div>)
}
