    ...
    return(
        <>
            <div className="footer-container text-white bg-[#3d3d3d] mt-20">
                <button className='block m-auto text-xl rounded-full bg-[rgb(62,161,181)] px-8 py-2 relative bottom-5'>Consultant</button>
                <div className="link-column grid sm:grid-cols-4 grid-cols-1 pb-10 justify-items-center">
                    <div className="important-links w-[70%]  sm:mb-0 mb-8">
                        <h3 className='border-b-2 border-[rgb(255,118,60)] text-2xl pr-3 pb-1 mt-1 mb-5'>Important Links</h3>
                    ...
                    <div className="important-links w-[70%]  sm:mb-0 mb-8">
                        <h3 className='border-b-2 border-[rgb(255,118,60)] text-2xl pr-3 pb-1 mt-1 mb-5'>Treatment</h3>
                    ...
                    <div className="important-links w-[70%]  sm:mb-0 mb-8">
                        <h3 className='border-b-2 border-[rgb(255,118,60)] text-2xl pr-3 pb-1 mt-1 mb-5'>Our Hospital</h3>
                    ...
                    <div className="important-links w-[70%]  sm:mb-0 mb-8">
                        <h3 className='border-b-2 border-[rgb(255,118,60)] text-2xl pr-3 pb-1 mt-1 mb-5'>Contact Us</h3>
