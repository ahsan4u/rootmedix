...
function HospitalCard({data}) {
    ...
    return (
        <div onClick={loadingFn} className="filter saturate-[1.5] relative bg-white sm:w-64 w-[166px] shadow-[2px_2px_5px_gray] rounded-xl sm:rounded-xl my-3 overflow-hidden cursor-pointer">
