...
function HospitalCard({data, loading}) {
    return (
        <div className="bestHospital relative bg-white sm:w-64 w-[166px] shadow-[2px_2px_5px_gray] rounded-lg sm:rounded-xl my-3 overflow-hidden cursor-pointer">
